...
public class YmlUtils {
    ...
    private static String bootstrap_file = "classpath:config/application.yml";
...
//        Map<String,String> map = getYmlByFileName(key);
//        if(map==null)return null;
//        return map.get(key);
        if (key.equals("imageUrl")){

//            return ymlUtils.imageUrl;
            return "http://douyin.secondog.com.cn/douyin";
        }else {
            return "http://douyin.secondog.com.cn";
        }
    }
